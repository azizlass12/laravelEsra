        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.meets.index') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">meets Index</a>
            </div>
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.meets.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="sm:col-span-6 pt-5">
                            <label for="title" class="block text-sm font-medium text-gray-700">title</label>
                            <div class="mt-1">
                                <input id="title" rows="3" name="title"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" id="meets_date" name="meets_date"
